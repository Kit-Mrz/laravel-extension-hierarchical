...
class ComponentImpl extends TemplateAbstract implements TemplateCreatorContract
{
    ...
    public function handle() : array
    {
        ...
        // 保存文件名称
        $saveFilename = $saveDirectory . '/' . $name . 'Impl.php';

        // 模板文件
        $sourceTemplateFile = __DIR__ . '/tpl/ComponentImpl.tpl';

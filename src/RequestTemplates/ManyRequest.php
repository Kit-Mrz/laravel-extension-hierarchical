...
class ManyRequest extends TemplateAbstract implements TemplateCreatorContract
{
    use TemplateTool;
    ...
    public function handle() : array
    {
        ...
        // 保存文件名称
        $saveFilename = $saveDirectory . '/' . $controlName . 'ManyRequest.php';

        // 模板文件
        $sourceTemplateFile = __DIR__ . '/tpl/ManyRequest.tpl';

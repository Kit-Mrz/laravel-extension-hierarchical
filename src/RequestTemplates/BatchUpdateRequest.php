...
class BatchUpdateRequest extends TemplateAbstract implements TemplateCreatorContract
{
    use TemplateTool;
    ...
    public function handle() : array
    {
        ...
        $templateRender      = $parser->getUpdateTemplateRender($this->getIgnoreFields(), true);
        $ruleUpdateString    = $templateRender->getRuleString();
        $messageUpdateString = $templateRender->getMessageString();
